              ...
              {isLoading ? (
                ...
                <>
                  ...
                  >
                    ...
                    problems. Build the confidence to tackle any coding
                    challenge independently with our
                  ...
                  >
                    <Button
                      asChild
                      size="lg"
                      className="group bg-gradient-to-r from-blue-600 to-purple-600 hover:from-blue-700 hover:to-purple-700 text-lg px-8 py-4 shadow-lg hover:shadow-xl transform hover:-translate-y-1 transition-all duration-300"
                    >
                      <Link href="/app">
                    ...
                    >
                      ...
                      <DialogContent className="max-w-4xl">
                        <DialogHeader>
                          <DialogTitle>
                            See Anti-Tutorial Hell in Action
                          </DialogTitle>
                        </DialogHeader>
                  ...
                  <Card className="bg-gradient-to-r from-blue-50 to-purple-50 dark:from-blue-900/20 dark:to-purple-900/20 border-blue-200 dark:border-blue-700">
                    <CardContent className="p-6">
                      <p className="text-blue-900 dark:text-blue-200 font-medium">
                        This struggle is not a bug—it&apos;s the feature that
                        builds genuine developer confidence.
                      </p>
                    </CardContent>
                  </Card>
                </div>
          ...
          <div className="max-w-7xl mx-auto px-4 sm:px-6 lg:px-8">
            ...
            >
              ...
              <p className="text-xl text-gray-600 dark:text-gray-400 max-w-3xl mx-auto">
                See how developers transformed their careers by escaping
                tutorial hell
              </p>
            </motion.div>
              ...
              {[
                ...
                >
                  <Card className="hover:shadow-lg transition-all duration-300 border-0 shadow-md">
                    <CardHeader>
                      <CardTitle className="text-left text-lg text-gray-900 dark:text-white">
                        {faq.question}
                      </CardTitle>
                    </CardHeader>
                    <CardContent>
          ...
          <div className="max-w-4xl mx-auto text-center px-4 sm:px-6 lg:px-8 relative">
            ...
            >
              ...
              <p className="text-xl text-blue-100 mb-8 max-w-2xl mx-auto">
                Join thousands of developers who chose struggle-first learning
                and built unshakeable coding confidence.
              </p>
              <div className="flex flex-col sm:flex-row gap-4 justify-center">
                <Button
                  ...
                  size="lg"
                  variant="secondary"
                  className="text-lg px-8 py-4 bg-white text-blue-600 hover:bg-gray-100 shadow-lg hover:shadow-xl transform hover:-translate-y-1"
                >
                  <Link href="/app">
